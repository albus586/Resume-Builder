...
export const features = [
  {
    title: "Goal Tracking",
    description:
      "Easily monitor key objectives and milestones to ensure project success.",
    icon: (
  ...
  },
  {
    ...
    description:
      "Analyze team interactions and improve collaboration for better performance.",
    icon: (
      <svg className="h-8 w-8" fill="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    title: "Data Insights",
    description:
      "Utilize advanced analytics to identify trends and optimize engagement strategies.",
    icon: (
      <svg className="h-8 w-8" fill="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    ...
    description:
      "Develop and implement data-driven strategies for long-term success.",
    icon: (
      <svg className="h-8 w-8" fill="currentColor" viewBox="0 0 24 24">
        <path
          fillOpacity=".48"
  ...
  },
  {
    ...
    description:
      "Create personalized workflows to match your team's unique processes.",
    icon: (
      <svg className="h-8 w-8" fill="currentColor" viewBox="0 0 24 24">
        <path
          fillOpacity=".48"
  ...
  },
  {
    ...
    description:
      "Bring together project timelines and updates in one unified view.",
    icon: (
      <svg className="h-8 w-8" fill="currentColor" viewBox="0 0 24 24">
        <path
          fillOpacity=".48"
